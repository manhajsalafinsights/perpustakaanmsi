...
export default function BookDetailClient({ id }: { id: string }) {
  ...
  const handlePaymentConfirm = () => {
    ...
    if (paymentMode === "donate") {
      ...
      const msg = [
        "Assalamu'alaikum, saya ingin memberi dukungan untuk pengembang buku:",
        "",
        "*" + book.title + "*",
              ...
              {isPaid && (
                <>
                  ...
                  <div className="flex items-center justify-center gap-1.5 mb-4 sm:mb-6 text-xs text-muted">
                    ...
                    <span>Buku ini berbayar — dukung pengembang agar terus berkarya.</span>
                  </div>
                </>
              )}
                  ...
                  {showPreviewEnd ? (
                    <div className="flex flex-col items-center justify-center text-center px-6 py-16 w-full max-w-md mx-auto">
                      ...
                      <p className="text-sm text-muted leading-relaxed mb-6">
                        ...
                        Buku ini berbayar — dukung pengembang agar terus berkarya
                        dengan membelinya.
                      </p>
                      <button
                        onClick={handleBuyWhatsApp}
          ...
          <div className="glass rounded-2xl p-6 sm:p-8 max-w-md w-full border border-accent/20 shadow-2xl">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-lg font-semibold text-foreground">
                {paymentMode === "donate" ? "Dukung Pengembang" : "Info Pembayaran"}
              </h3>
              <button
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs text-muted text-center flex items-center justify-center gap-1">
                ...
                Terima kasih! {paymentMode === "donate" ? "Dukungan Anda" : "Pembelian Anda"} sangat berarti bagi pengembang.
              </p>
            </div>
          </div>
        </div>
